...
Window::WindowClass::WindowClass()
{
	...
	wc.hIcon = static_cast<HICON>(LoadImage(hinst, MAKEINTRESOURCE(IDB_PNG1) , IMAGE_ICON,256 , 256 , 0 ));
	wc.hIconSm = static_cast<HICON>(LoadImage(hinst, MAKEINTRESOURCE(IDB_PNG1), IMAGE_ICON, 256 , 256 , 0));
	RegisterClassEx(&wc);
}
Window::WindowClass::~WindowClass()
{
